...
namespace Illuminate\Support\Facades {
     ...
     */        class Schema {
        ...
        {            //Method inherited from \Illuminate\Database\Schema\Builder         
                        \Yajra\Oci8\Schema\OracleBuilder::morphUsingUlids();
        }
                    /**
        ...
        {            //Method inherited from \Illuminate\Database\Schema\Builder         
                        \Yajra\Oci8\Schema\OracleBuilder::useNativeSchemaOperationsIfPossible($value);
        }
                    /**
         ...
         */        public static function macro($name, $macro)
        {            //Method inherited from \Illuminate\Database\Schema\Builder         
                        \Yajra\Oci8\Schema\OracleBuilder::macro($name, $macro);
        }
                    /**
         * Mix another object into the class.
         *
         ...
         */        public static function mixin($mixin, $replace = true)
        {            //Method inherited from \Illuminate\Database\Schema\Builder         
                        \Yajra\Oci8\Schema\OracleBuilder::mixin($mixin, $replace);
        }
                    /**
         * Checks if macro is registered.
         *
         ...
         */        public static function hasMacro($name)
        {            //Method inherited from \Illuminate\Database\Schema\Builder         
                        return \Yajra\Oci8\Schema\OracleBuilder::hasMacro($name);
        }
                    /**
         * Flush the existing macros.
         *
         ...
         */        public static function flushMacros()
        {            //Method inherited from \Illuminate\Database\Schema\Builder         
                        \Yajra\Oci8\Schema\OracleBuilder::flushMacros();
        }
            }
            /**
     * 
